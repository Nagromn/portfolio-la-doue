...
(function ($) {
	...
	$.fn.menuBar = function (options) {
		...
		var defaults = {
			...
			width: 320, // Width of Sidebar
			left: false, // BRAVO BRAVO de Doudoue If true, sidebar is positioned left. If false, it's positioned right
			height: 0, // Height of footer
			barColor: '#00A597', // Color of three-bar menu before it's opened
			menuBackground: 'rgba(255, 255, 255, 1)', // transparence menu + Background color of sidebar and footer
			closeColor: '#00A597' // Color of close-button
		};
		...
		return this.each(function () {
			...
			nav.css({
 			...
 			$('.menu-trigger').css(direction, 20); // c'est la qu'on choisi l'espace exterieur du menu
